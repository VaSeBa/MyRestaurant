...
public class VoteTestData {
    ...
    public static final Vote vote_2 = new Vote(2, user, LocalDate.parse("2022-05-21"), LocalTime.parse("09:15:00"), MAC_ID);
    public static final Vote vote_3 = new Vote(3, user, LocalDate.parse("2022-05-20"), LocalTime.parse("15:55:00"), WASABI_ID);
    public static final Vote vote_4 = new Vote(4, admin, LocalDate.parse("2022-05-21"), LocalTime.parse("08:15:00"), SHALYPIN_ID);
    public static final Vote vote_5 = new Vote(5, admin, LocalDate.parse("2022-05-20"), LocalTime.parse("12:55:00"), WASABI_ID);
}
