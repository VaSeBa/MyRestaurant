...
INSERT INTO DISH_REF (NAME, PRICE)
VALUES ('Филе-о-Фиш', 12700),
       ('Чикенбургер', 5000),
       ('Чикен Макнаггетс (20шт)', 27200),

       ('Борщ с фасолью и чесночной пампушкой', 49000),
       ('Рассольник по-шаляпински', 55000),
       ('Шницель из телятины с квашеной капустой и печеным яблоком', 95000),

       ('Ролл Сочная креветка', 25700),
       ('Ролл Огонь', 31700),
       ('Ролл Калифорния с цыпленком', 12900);
